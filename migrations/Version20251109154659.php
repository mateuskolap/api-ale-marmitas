 ...
 */
final class Version20251109154659 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payments (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, amount NUMERIC(10, 2) NOT NULL, change_given NUMERIC(10, 2) NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', method VARCHAR(32) NOT NULL, notes VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_65D29B329395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
